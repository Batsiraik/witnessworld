(function () {
  ...
  const ROWS = [
    { title: 'Marketplace listing', sub: 'Sell pre-loved goods & items', href: 'create-listing.html?type=classified', icon: 'bag-handle-outline', bg: '#E8F4FD', color: '#1D4ED8' },
    ...
    { title: 'Classifieds post', sub: 'Housing, jobs, sitters, announcements', href: 'create-listing.html?type=community', icon: 'newspaper-outline', bg: '#FEF3C7', color: '#B45309' },
